...
import com.example.godzillafinance.R;
...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FadOpen= AnimationUtils.loadAnimation(getActivity(), android.R.anim.fade_in);
        FadClose=AnimationUtils.loadAnimation(getActivity(), android.R.anim.fade_out);
        Rob=AnimationUtils.loadAnimation(getActivity(), android.R.anim.fade_out);
        Rof=AnimationUtils.loadAnimation(getActivity(),android.R.anim.fade_in);
